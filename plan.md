...
- [ ] **Remediation P4 — granular CLI gatekeeper** — pending: per-spec `[a]pprove/[r]eject/[t]oggle risk tags/[q]uit` loop returning a curated `GatekeeperDecision {status, specs}` (D4).
